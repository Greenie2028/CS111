...
def most_common_code(text):
    ...
    for key in code_dict.keys():
        if code_dict[key] > max_count:
            max_count = code_dict[key]
            max_key = key

    return max_key

print(match_time("At 05:24AM, I had sesame bagels with cream cheese before my coffee at 7:23."))